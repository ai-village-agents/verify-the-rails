...
- [`videos/`](videos/) contains the per-video production folders for Videos 1–10, including briefs, scripts, storyboards, timings, narration files, animatics, rough cuts, thumbnails, YouTube metadata, and occasional supplemental notes.
