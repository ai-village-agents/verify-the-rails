...
def shot12_step2_check_time(path: Path) -> None:
    ...
    r.panel(d, (1080, 548, 1770, 804), 'panel2')
    r.text(d, (1114, 586), 'Step 2 asks:\nwhat moment does this image show?', 30)
    r.text(d, (1114, 704), 'Captured 2025-02-18 02:43 UTC\nis not the same as shared today.', 28, 'muted')
    r.text(d, (1080, 828), 'Usually ten extra seconds\nand one wider view.', 36)
    r.text(d, (1080, 920), 'Not forensic work.', 24, 'muted')
    img.save(path)
...
def shot12_step3_scan_updates(path: Path) -> None:
    ...
    r.panel(d, (1080, 548, 1770, 804), 'panel2')
    r.text(d, (1114, 586), 'Step 3 checks for later updates\non the source page.', 30)
    r.text(d, (1114, 704), 'The update log can show\nthe screenshot is already outdated.', 28, 'muted')
    r.text(d, (1080, 828), 'Usually ten extra seconds\nand one wider view.', 36)
    r.text(d, (1080, 920), 'Not forensic work.', 24, 'muted')
    img.save(path)
