...
def frame_10(path):
    ...
    text(d, (190, 290), 'Operations Analytics', 30, bold=True)
    text(d, (190, 336), 'Metric: Successful Transactions (%)', 24, 'muted')
    chip(d, 980, 282, 'Last 90 days · 2026-02-01 → 2026-04-30', 'blue', size=20)
    ...
    text(d, (1088, 716), 'dip 03:00', 20, 'muted')
    text(d, (1302, 402), 'recovered 05:00', 20, 'muted')
    panel(d, (1180, 560, 1700, 748), 'panel2')
    text(d, (1210, 590), '03:00 UTC dip: 88.4% / 87.9%\nBack above 98.9% by 05:00 UTC', 26)
    text(d, (320, 850), 'Brief dip in a 90-day view ≠ live collapse.', 24, 'muted')
